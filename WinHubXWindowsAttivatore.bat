...
set "_title=WinHubX Windows Attivatore KMS"
set _gui=
...
cls
mode con cols=91 lines=30
title  WinHubX Windows Attivatore Auto-Renewal
...
mode 110, 34
if exist "%Systemdrive%\Windows\System32\spp\store_test\" mode 134, 34
title  WinHubX Windows Attivatore KMS3
...
cls
mode 99, 28
title  WinHubX Windows Disattiva KMS38
